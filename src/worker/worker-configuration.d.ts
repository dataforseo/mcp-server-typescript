/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker/worker-configuration.d.ts` (hash: 2db10083300822b6b1b5f176db241dbd)
// Runtime types generated with workerd@1.20251113.0 2025-11-13 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../build/worker/worker/index-worker");
		durableNamespaces: "DataForSEOUniversalMcpAgent";
	}
	interface Env {
		AUTH_SERVER_URL: "https://data.dataforseo.com";
		MCP_OBJECT: DurableObjectNamespace<import("../../build/worker/worker/index-worker").DataForSEOUniversalMcpAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_SERVER_URL">> {}
}
